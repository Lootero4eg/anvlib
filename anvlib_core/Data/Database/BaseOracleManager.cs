...
namespace anvlib.Data.Database
{
    ...
    public class BaseOracleManager : BaseDbManager
    {
        ...
        internal override void PrepareTableSchemeBeforeFill(DataTable table, bool with_primary_key, bool with_max_string_length, bool with_default_values, bool CaseSensivity)
        {
